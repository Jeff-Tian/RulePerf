// -----------------------------------------------------------------------
// <copyright file="RunReplayToolForChangedStep.cs" company="Microsoft">
...
namespace Microsoft.Scs.Test.RiskTools.RulePerf.Model
{
    ...
    /// <summary>
    /// A step to run replay tool for changed patched run
    /// </summary>
    [Serializable]
    public class RunReplayToolForChangedStep : Step
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RunReplayToolForChangedStep" /> class with default properties.
        /// </summary>
        public RunReplayToolForChangedStep()
        {
            this.Name = "Run replay tool for rule changed testing";
            this.Description = "Run replay tool for rule changed testing.";
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="RunReplayToolForChangedStep" /> class with Customized properties.
        /// </summary>
        /// <param name="name">The step name.</param>
        /// <param name="description">The description for this step.</param>
        public RunReplayToolForChangedStep(string name, string description)
        {
            this.Name = name;
